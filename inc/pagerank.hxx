 ...
 */
template <bool ASYNC=false, class H, class V, class FI, class FA, class FR, class FM>
inline PagerankResult<V> pagerankInvoke(const H& xt, const vector<V> *q, const PagerankOptions<V>& o, FI fi, FA fa, FR fr, FM fm) {
  using  K = typename H::key_type;
  size_t S = xt.span();
  size_t N = xt.order();
  V   P  = o.damping;
 ...
 */
template <bool ASYNC=false, class H, class V, class FI, class FA, class FR, class FM>
inline PagerankResult<V> pagerankInvokeOmp(const H& xt, const vector<V> *q, const PagerankOptions<V>& o, FI fi, FA fa, FR fr, FM fm) {
  using  K = typename H::key_type;
  size_t S = xt.span();
  size_t N = xt.order();
  V   P  = o.damping;
...
inline PagerankResult<V> pagerankStatic(const H& xt, const PagerankOptions<V>& o) {
  ...
  auto fr = [](K u, V eu) {};
  auto fm = []() {};
  return pagerankInvoke<ASYNC>(xt, q, o, fi, fa, fr, fm);
}
...
inline PagerankResult<V> pagerankStaticOmp(const H& xt, const PagerankOptions<V>& o) {
  ...
  auto fr = [](K u, V eu) {};
  auto fm = []() {};
  return pagerankInvokeOmp<ASYNC>(xt, q, o, fi, fa, fr, fm);
}
#endif
#pragma endregion
...
inline PagerankResult<V> pagerankDynamicFrontier(const G& x, const H& xt, const G& y, const H& yt, const vector<tuple<K, K>>& deletions, const vector<tuple<K, K>>& insertions, const vector<V> *q, const PagerankOptions<V>& o) {
  ...
  return pagerankInvoke<ASYNC>(yt, q, o, fi, fa, fr, fm);
}
...
inline PagerankResult<V> pagerankDynamicFrontierOmp(const G& x, const H& xt, const G& y, const H& yt, const vector<tuple<K, K>>& deletions, const vector<tuple<K, K>>& insertions, const vector<V> *q, const PagerankOptions<V>& o) {
  ...
  return pagerankInvokeOmp<ASYNC>(yt, q, o, fi, fa, fr, fm);
}
#endif
#pragma endregion
#pragma endregion
